    ...
    <footer className="border-t border-border mt-32">
      ...
      <div className="mx-auto max-w-[1600px] px-5 lg:px-8 py-10 grid gap-8 md:grid-cols-12 items-start">
        <div className="md:col-span-4">
          <Link href="/" className="font-display font-extrabold text-base tracking-tight">
        ...
        <div className="md:col-span-4 md:col-start-6">
          ...
          <ul className="space-y-2 text-sm">
            <li><Link href="/" className="hover:text-gold transition-colors">Index</Link></li>
            <li><Link href="/portfolio" className="hover:text-gold transition-colors">Works</Link></li>
            <li><Link href="/services" className="hover:text-gold transition-colors">Services</Link></li>
            <li><Link href="/book" className="hover:text-gold transition-colors">Contact</Link></li>
          </ul>
        </div>
